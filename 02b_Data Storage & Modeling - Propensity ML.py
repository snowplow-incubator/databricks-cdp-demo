...
# MAGIC 
# MAGIC Snowplow web tracking includes engagement metrics out of the box:
...
df_spark = spark.createDataFrame(df[["domain_userid", "propensity_score"]])
...
# MAGIC %md 
# MAGIC We have utilised Snowplow's rich behavioural data in this model to generate these scores which can now be used to improve audience segmentation and maximise conversions.
